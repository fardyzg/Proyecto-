<?php
	...
	function registraContacto($nombre, $correo, $telefono, $dni){
		
		global $mysqli;
		
		$stmt = $mysqli->prepare("INSERT INTO contacto (nombre , correo, telefono, dni) VALUES(?,?,?,?)");
		$stmt->bind_param('ssii', $nombre, $correo, $telefono, $dni);
	...
	function registraUsuario($usuario, $pass_hash, $nombre, $email, $mascota, $activo, $token, $tipo_usuario){
		
		global $mysqli;
		
		$stmt = $mysqli->prepare("INSERT INTO usuarios (usuario, password, nombre, correo, mascota, activacion, token, id_tipo) VALUES(?,?,?,?,?,?,?,?)");
		$stmt->bind_param('sssssisi', $usuario, $pass_hash, $nombre, $email, $mascota, $activo, $token, $tipo_usuario);
	...
	function registraMatricula($nombre, $apellido, $direccion, $telefono, $nacionalidad, $tdocumento,$Numdocumento,$edad){
		
		global $mysqli;
		
		$stmt = $mysqli->prepare("INSERT INTO matricula (nombre, apellido, direccion, telefono, tdocumento, Numdocumento, edad) VALUES(?,?,?,?,?,?,?)");
		$stmt->bind_param('ssssisi', $nombre, $apellido, $direccion, $telefono, $nacionalidad, $tdocumento,$Numdocumento,$edad);
	...
	/*function registraMatricula($nombre, $apellido, $direccion, $telefono, $numDocumento, $edad, $grado, $genero){
		
		global $mysqli;
		
		$stmt = $mysqli->prepare("INSERT INTO matricula (nombre, apellido, direccion, telefono, numDocumento, edad, grado, genero) VALUES(?,?,?,?,?,?,?,?)");
		$stmt->bind_param('sssiiiss',$nombre, $apellido, $direccion, $telefono, $numDocumento, $edad, $grado, $genero);
